...
export class Uploader {
    constructor(options) {
        ...
        this.multipartEndpoint = options.multipartEndpoint;
        ...
        this.imageTypeUpload = options?.typeImage;
    ...
    async initialize() {
        try {
            ...
            localStorage.setItem("upload_file", AWSFileDataOutput.fileKey);
            ...
            const urlsResponse = await axios.request({
                url: this.multipartEndpoint,
                method: "POST",
                data: AWSMultipartFileDataInput,
            });

            console.log('urlsResponse.data______', urlsResponse.data);
    ...
    async sendCompleteRequest() {
        ...
        if (this.fileId && this.fileKey) {
            const videoFinalizationMultiPartInput = {
                ...
                file_extension: this.imageTypeUpload,
    ...
    onFinish(onFinish) {
        // EventEmitter.emit(EMITTER_SUCCESS, "Successfully uploaded");
